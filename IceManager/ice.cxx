...
DDS_TypeCode* UniqueDeviceIdentifier_get_typecode()
{
    static RTIBool is_initialized = RTI_FALSE;

    static DDS_TypeCode UniqueDeviceIdentifier_g_tc_string = DDS_INITIALIZE_STRING_TYPECODE(64);

    static DDS_TypeCode UniqueDeviceIdentifier_g_tc =
    {{
        DDS_TK_ALIAS, /* Kind*/
        DDS_BOOLEAN_FALSE, /* Is a pointer? */
        -1, /* Ignored */
        (char *)"ice::UniqueDeviceIdentifier", /* Name */
        ...
        NULL, /* Ignored */
        DDS_VM_NONE /* Ignored */
    }}; /* Type code for UniqueDeviceIdentifier */

    if (is_initialized) {
        return &UniqueDeviceIdentifier_g_tc;
    }

    UniqueDeviceIdentifier_g_tc._data._typeCode = (RTICdrTypeCode *)&UniqueDeviceIdentifier_g_tc_string; /* Content type code */
...
{
    return ::ice::UniqueDeviceIdentifier_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
}

RTIBool UniqueDeviceIdentifier_initialize_ex(
    UniqueDeviceIdentifier* sample,RTIBool allocatePointers,RTIBool allocateMemory)
{
...
void UniqueDeviceIdentifier_finalize(
    UniqueDeviceIdentifier* sample)
{
    ::ice::UniqueDeviceIdentifier_finalize_ex(sample,RTI_TRUE);
}
            
void UniqueDeviceIdentifier_finalize_ex(
    UniqueDeviceIdentifier* sample,RTIBool deletePointers)
{
 ...
 * Defines:  TSeq, T
 *
 * Configure and implement 'UniqueDeviceIdentifier' sequence class.
 */
#define T            UniqueDeviceIdentifier
#define TSeq         UniqueDeviceIdentifierSeq
#define T_initialize_ex ::ice::UniqueDeviceIdentifier_initialize_ex
#define T_finalize_ex   ::ice::UniqueDeviceIdentifier_finalize_ex
#define T_copy       ::ice::UniqueDeviceIdentifier_copy
...
DDS_TypeCode* MetricIdentifier_get_typecode()
{
    static RTIBool is_initialized = RTI_FALSE;

    static DDS_TypeCode MetricIdentifier_g_tc_string = DDS_INITIALIZE_STRING_TYPECODE(64);

    static DDS_TypeCode MetricIdentifier_g_tc =
    {{
        DDS_TK_ALIAS, /* Kind*/
        DDS_BOOLEAN_FALSE, /* Is a pointer? */
        -1, /* Ignored */
        (char *)"ice::MetricIdentifier", /* Name */
        NULL, /* Content type code is assigned later */
        0, /* Ignored */
        0, /* Ignored */
        NULL, /* Ignored */
        ...
        NULL, /* Ignored */
        DDS_VM_NONE /* Ignored */
    }}; /* Type code for MetricIdentifier */

    if (is_initialized) {
        return &MetricIdentifier_g_tc;
    }

    MetricIdentifier_g_tc._data._typeCode = (RTICdrTypeCode *)&MetricIdentifier_g_tc_string; /* Content type code */
...
{
    return ::ice::MetricIdentifier_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
}

RTIBool MetricIdentifier_initialize_ex(
    MetricIdentifier* sample,RTIBool allocatePointers,RTIBool allocateMemory)
{
...
void MetricIdentifier_finalize(
    MetricIdentifier* sample)
{
    ::ice::MetricIdentifier_finalize_ex(sample,RTI_TRUE);
}
            
void MetricIdentifier_finalize_ex(
    MetricIdentifier* sample,RTIBool deletePointers)
{
    if (sample) {} /* To avoid warnings */
    if (deletePointers) {} /* To avoid warnings */
 ...
 * Defines:  TSeq, T
 *
 * Configure and implement 'MetricIdentifier' sequence class.
 */
#define T            MetricIdentifier
#define TSeq         MetricIdentifierSeq
#define T_initialize_ex ::ice::MetricIdentifier_initialize_ex
#define T_finalize_ex   ::ice::MetricIdentifier_finalize_ex
#define T_copy       ::ice::MetricIdentifier_copy
...
DDS_TypeCode* InstanceIdentifier_get_typecode()
{
    ...
    InstanceIdentifier_g_tc._data._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long; /* Content type code */
...
#define T_initialize_ex ::ice::InstanceIdentifier_initialize_ex
#define T_finalize_ex   ::ice::InstanceIdentifier_finalize_ex
...
DDS_TypeCode* DeviceIdentity_get_typecode()
{
    ...
    static DDS_TypeCode DeviceIdentity_g_tc_serial_number_string = DDS_INITIALIZE_STRING_TYPECODE(128);

    static DDS_TypeCode_Member DeviceIdentity_g_tc_members[5]=
    {
        {
            (char *)"unique_device_identifier",/* Member name */
            {
                0,/* Representation ID */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
    ...
    DeviceIdentity_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::UniqueDeviceIdentifier_get_typecode();
    ...
    DeviceIdentity_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&DeviceIdentity_g_tc_serial_number_string;
    DeviceIdentity_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)ice::Image_get_typecode();
    ...
    DeviceIdentity* sample,RTIBool allocatePointers,RTIBool allocateMemory)
{
    ...
    if (!ice::UniqueDeviceIdentifier_initialize_ex(&sample->unique_device_identifier,allocatePointers,allocateMemory)) {
        return RTI_FALSE;
    }
    ...
    if (allocateMemory) {
        sample->serial_number = DDS_String_alloc((128));
        if (sample->serial_number == NULL) {
            return RTI_FALSE;
        }
    } else {
        if (sample->serial_number != NULL) { 
            sample->serial_number[0] = '\0';
        }
    }
...
{        
    ...
    ice::UniqueDeviceIdentifier_finalize_ex(&sample->unique_device_identifier,deletePointers);
    ...
    DDS_String_free(sample->serial_number);                
...
{        
    ...
    if (!RTICdrType_copyString(
        dst->serial_number, src->serial_number, (128) + 1)) {
        return RTI_FALSE;
    }
...
DDS_TypeCode* DeviceConnectivity_get_typecode()
{
    ...
    DeviceConnectivity_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::UniqueDeviceIdentifier_get_typecode();
...
DDS_TypeCode* DeviceConnectivityObjective_get_typecode()
{
    ...
    DeviceConnectivityObjective_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::UniqueDeviceIdentifier_get_typecode();
...
DDS_TypeCode* Numeric_get_typecode()
{
    ...
    static DDS_TypeCode_Member Numeric_g_tc_members[4]=
    {
        {
            (char *)"unique_device_identifier",/* Member name */
            {
    ...
    Numeric_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::UniqueDeviceIdentifier_get_typecode();
    Numeric_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)ice::MetricIdentifier_get_typecode();
    Numeric_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)ice::InstanceIdentifier_get_typecode();
    Numeric_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_float;
    ...
    Numeric* sample,RTIBool allocatePointers,RTIBool allocateMemory)
{
    ...
    if (!ice::MetricIdentifier_initialize_ex(&sample->metric_id,allocatePointers,allocateMemory)) {
        return RTI_FALSE;
    }
            

    if (!ice::InstanceIdentifier_initialize_ex(&sample->instance_id,allocatePointers,allocateMemory)) {
        return RTI_FALSE;
    }
...
{        
    ...
    ice::MetricIdentifier_finalize_ex(&sample->metric_id,deletePointers);
            

    ice::InstanceIdentifier_finalize_ex(&sample->instance_id,deletePointers);
...
DDS_TypeCode* SampleArray_get_typecode()
{
    ...
    static DDS_TypeCode SampleArray_g_tc_values_sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(400,NULL);

    static DDS_TypeCode_Member SampleArray_g_tc_members[5]=
    {
        {
            (char *)"unique_device_identifier",/* Member name */
            {
    ...
    SampleArray_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::UniqueDeviceIdentifier_get_typecode();
    SampleArray_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)ice::MetricIdentifier_get_typecode();
    SampleArray_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)ice::InstanceIdentifier_get_typecode();
    SampleArray_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&SampleArray_g_tc_values_sequence;
    SampleArray_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
...
DDS_TypeCode* Text_get_typecode()
{
    ...
    static DDS_TypeCode_Member Text_g_tc_members[4]=
    {
        {
            (char *)"unique_device_identifier",/* Member name */
            {
    ...
    Text_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::UniqueDeviceIdentifier_get_typecode();
    Text_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)ice::MetricIdentifier_get_typecode();
    Text_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)ice::InstanceIdentifier_get_typecode();
    Text_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&Text_g_tc_value_string;
...
/* ========================================================================= */
const char *InfusionObjectiveTYPENAME = "ice::InfusionObjective";

DDS_TypeCode* InfusionObjective_get_typecode()
{
    static RTIBool is_initialized = RTI_FALSE;

    static DDS_TypeCode InfusionObjective_g_tc_requestor_string = DDS_INITIALIZE_STRING_TYPECODE(128);

    static DDS_TypeCode_Member InfusionObjective_g_tc_members[3]=
    {
        {
            (char *)"unique_device_identifier",/* Member name */
            {
    ...
    static DDS_TypeCode InfusionObjective_g_tc =
    {{
        DDS_TK_STRUCT,/* Kind */
        DDS_BOOLEAN_FALSE, /* Ignored */
        -1,/* Ignored */
        (char *)"ice::InfusionObjective", /* Name */
        NULL, /* Ignored */
        0, /* Ignored */
        0, /* Ignored */
        NULL, /* Ignored */
        3, /* Number of members */
        InfusionObjective_g_tc_members, /* Members */
        DDS_VM_NONE /* Ignored */
    }}; /* Type code for InfusionObjective*/

    if (is_initialized) {
        return &InfusionObjective_g_tc;
    }


    InfusionObjective_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::UniqueDeviceIdentifier_get_typecode();
    InfusionObjective_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&InfusionObjective_g_tc_requestor_string;
    InfusionObjective_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_boolean;
...
RTIBool InfusionObjective_initialize(
  ...
  return ::ice::InfusionObjective_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
}
        
RTIBool InfusionObjective_initialize_ex(
    InfusionObjective* sample,RTIBool allocatePointers,RTIBool allocateMemory)
{
    ...
    if (allocateMemory) {
        sample->requestor = DDS_String_alloc((128));
        if (sample->requestor == NULL) {
            return RTI_FALSE;
        }
    } else {
        if (sample->requestor != NULL) { 
            sample->requestor[0] = '\0';
        }
    }
            

    if (!RTICdrType_initBoolean(&sample->stopInfusion)) {
        return RTI_FALSE;
    }                
...
void InfusionObjective_finalize(
    InfusionObjective* sample)
{
    ::ice::InfusionObjective_finalize_ex(sample,RTI_TRUE);
}
        
void InfusionObjective_finalize_ex(
    InfusionObjective* sample,RTIBool deletePointers)
{        
    if (sample) { } /* To avoid warnings */
    if (deletePointers) {} /* To avoid warnings */
    ...
    DDS_String_free(sample->requestor);                
...
{        
    ...
    if (!RTICdrType_copyString(
        dst->requestor, src->requestor, (128) + 1)) {
        return RTI_FALSE;
    }
            

    if (!RTICdrType_copyBoolean(
        &dst->stopInfusion, &src->stopInfusion)) {
        return RTI_FALSE;
    }
 ...
 * Defines:  TSeq, T
 *
 * Configure and implement 'InfusionObjective' sequence class.
 */
#define T InfusionObjective
#define TSeq InfusionObjectiveSeq
#define T_initialize_ex ::ice::InfusionObjective_initialize_ex
#define T_finalize_ex   ::ice::InfusionObjective_finalize_ex
#define T_copy       ::ice::InfusionObjective_copy
...
/* ========================================================================= */
const char *InfusionStatusTYPENAME = "ice::InfusionStatus";

DDS_TypeCode* InfusionStatus_get_typecode()
{
    static RTIBool is_initialized = RTI_FALSE;

    static DDS_TypeCode InfusionStatus_g_tc_drug_name_string = DDS_INITIALIZE_STRING_TYPECODE(256);

    static DDS_TypeCode_Member InfusionStatus_g_tc_members[8]=
    {
        {
            (char *)"unique_device_identifier",/* Member name */
            {
        ...
        {
            (char *)"infusionActive",/* Member name */
            {
                0,/* Representation ID */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
        ...
        {
            (char *)"drug_mass_mcg",/* Member name */
            {
                0,/* Representation ID */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
        ...
        {
            (char *)"solution_volume_ml",/* Member name */
            {
                0,/* Representation ID */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
        ...
        {
            (char *)"volume_to_be_infused_ml",/* Member name */
            {
                0,/* Representation ID */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
        ...
        {
            (char *)"infusion_duration_seconds",/* Member name */
            {
                0,/* Representation ID */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
        ...
        {
            (char *)"infusion_fraction_complete",/* Member name */
            {
                0,/* Representation ID */
                DDS_BOOLEAN_FALSE,/* Is a pointer? */
                -1, /* Bitfield bits */
    ...
    static DDS_TypeCode InfusionStatus_g_tc =
    {{
        DDS_TK_STRUCT,/* Kind */
        DDS_BOOLEAN_FALSE, /* Ignored */
        -1,/* Ignored */
        (char *)"ice::InfusionStatus", /* Name */
        NULL, /* Ignored */
        0, /* Ignored */
        0, /* Ignored */
        NULL, /* Ignored */
        8, /* Number of members */
        InfusionStatus_g_tc_members, /* Members */
        DDS_VM_NONE /* Ignored */
    }}; /* Type code for InfusionStatus*/

    if (is_initialized) {
        return &InfusionStatus_g_tc;
    }


    InfusionStatus_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::UniqueDeviceIdentifier_get_typecode();
    InfusionStatus_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_boolean;
    InfusionStatus_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&InfusionStatus_g_tc_drug_name_string;
    InfusionStatus_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
    InfusionStatus_g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
    InfusionStatus_g_tc_members[5]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
    InfusionStatus_g_tc_members[6]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_long;
    InfusionStatus_g_tc_members[7]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_float;
...
RTIBool InfusionStatus_initialize(
  ...
  return ::ice::InfusionStatus_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
}
        
RTIBool InfusionStatus_initialize_ex(
    InfusionStatus* sample,RTIBool allocatePointers,RTIBool allocateMemory)
{
    ...
    if (!RTICdrType_initBoolean(&sample->infusionActive)) {
        return RTI_FALSE;
    }                
            

    if (allocateMemory) {
        sample->drug_name = DDS_String_alloc((256));
        if (sample->drug_name == NULL) {
            return RTI_FALSE;
        }
    } else {
        if (sample->drug_name != NULL) { 
            sample->drug_name[0] = '\0';
        }
    }
            

    if (!RTICdrType_initLong(&sample->drug_mass_mcg)) {
        return RTI_FALSE;
    }                
            

    if (!RTICdrType_initLong(&sample->solution_volume_ml)) {
        return RTI_FALSE;
    }                
            

    if (!RTICdrType_initLong(&sample->volume_to_be_infused_ml)) {
        return RTI_FALSE;
    }                
            

    if (!RTICdrType_initLong(&sample->infusion_duration_seconds)) {
        return RTI_FALSE;
    }                
            

    if (!RTICdrType_initFloat(&sample->infusion_fraction_complete)) {
        return RTI_FALSE;
    }                
...
void InfusionStatus_finalize(
    InfusionStatus* sample)
{
    ::ice::InfusionStatus_finalize_ex(sample,RTI_TRUE);
}
        
void InfusionStatus_finalize_ex(
    InfusionStatus* sample,RTIBool deletePointers)
{        
    if (sample) { } /* To avoid warnings */
    if (deletePointers) {} /* To avoid warnings */
    ...
    DDS_String_free(sample->drug_name);                
...
{        
    ...
    if (!RTICdrType_copyBoolean(
        &dst->infusionActive, &src->infusionActive)) {
        return RTI_FALSE;
    }
            

    if (!RTICdrType_copyString(
        dst->drug_name, src->drug_name, (256) + 1)) {
        return RTI_FALSE;
    }
            

    if (!RTICdrType_copyLong(
        &dst->drug_mass_mcg, &src->drug_mass_mcg)) {
        return RTI_FALSE;
    }
            

    if (!RTICdrType_copyLong(
        &dst->solution_volume_ml, &src->solution_volume_ml)) {
        return RTI_FALSE;
    }
            

    if (!RTICdrType_copyLong(
        &dst->volume_to_be_infused_ml, &src->volume_to_be_infused_ml)) {
        return RTI_FALSE;
    }
            

    if (!RTICdrType_copyLong(
        &dst->infusion_duration_seconds, &src->infusion_duration_seconds)) {
        return RTI_FALSE;
    }
            

    if (!RTICdrType_copyFloat(
        &dst->infusion_fraction_complete, &src->infusion_fraction_complete)) {
        return RTI_FALSE;
    }
 ...
 * Defines:  TSeq, T
 *
 * Configure and implement 'InfusionStatus' sequence class.
 */
#define T InfusionStatus
#define TSeq InfusionStatusSeq
#define T_initialize_ex ::ice::InfusionStatus_initialize_ex
#define T_finalize_ex   ::ice::InfusionStatus_finalize_ex
#define T_copy       ::ice::InfusionStatus_copy
...
/* ========================================================================= */
const char *AlarmSettingsTYPENAME = "ice::AlarmSettings";

DDS_TypeCode* AlarmSettings_get_typecode()
{
    static RTIBool is_initialized = RTI_FALSE;


    static DDS_TypeCode_Member AlarmSettings_g_tc_members[4]=
    {
        {
            (char *)"unique_device_identifier",/* Member name */
            {
    ...
    static DDS_TypeCode AlarmSettings_g_tc =
    {{
        DDS_TK_STRUCT,/* Kind */
        DDS_BOOLEAN_FALSE, /* Ignored */
        -1,/* Ignored */
        (char *)"ice::AlarmSettings", /* Name */
        NULL, /* Ignored */
        0, /* Ignored */
        0, /* Ignored */
        NULL, /* Ignored */
        4, /* Number of members */
        AlarmSettings_g_tc_members, /* Members */
        DDS_VM_NONE /* Ignored */
    }}; /* Type code for AlarmSettings*/

    if (is_initialized) {
        return &AlarmSettings_g_tc;
    }


    AlarmSettings_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::UniqueDeviceIdentifier_get_typecode();
    AlarmSettings_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)ice::MetricIdentifier_get_typecode();
    AlarmSettings_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_float;
    AlarmSettings_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_float;
...
RTIBool AlarmSettings_initialize(
  ...
  return ::ice::AlarmSettings_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
}
        
RTIBool AlarmSettings_initialize_ex(
    AlarmSettings* sample,RTIBool allocatePointers,RTIBool allocateMemory)
{
    ...
    if (!RTICdrType_initFloat(&sample->lower)) {
        return RTI_FALSE;
    }                
            

    if (!RTICdrType_initFloat(&sample->upper)) {
        return RTI_FALSE;
    }                
...
void AlarmSettings_finalize(
    AlarmSettings* sample)
{
    ::ice::AlarmSettings_finalize_ex(sample,RTI_TRUE);
}
        
void AlarmSettings_finalize_ex(
    AlarmSettings* sample,RTIBool deletePointers)
{        
    if (sample) { } /* To avoid warnings */
    if (deletePointers) {} /* To avoid warnings */
 ...
 * Defines:  TSeq, T
 *
 * Configure and implement 'AlarmSettings' sequence class.
 */
#define T AlarmSettings
#define TSeq AlarmSettingsSeq
#define T_initialize_ex ::ice::AlarmSettings_initialize_ex
#define T_finalize_ex   ::ice::AlarmSettings_finalize_ex
#define T_copy       ::ice::AlarmSettings_copy
...
/* ========================================================================= */
const char *GlobalAlarmSettingsObjectiveTYPENAME = "ice::GlobalAlarmSettingsObjective";

DDS_TypeCode* GlobalAlarmSettingsObjective_get_typecode()
{
    static RTIBool is_initialized = RTI_FALSE;


    static DDS_TypeCode_Member GlobalAlarmSettingsObjective_g_tc_members[3]=
    {
        {
            (char *)"metric_id",/* Member name */
            {
    ...
    static DDS_TypeCode GlobalAlarmSettingsObjective_g_tc =
    {{
        DDS_TK_STRUCT,/* Kind */
        DDS_BOOLEAN_FALSE, /* Ignored */
        -1,/* Ignored */
        (char *)"ice::GlobalAlarmSettingsObjective", /* Name */
        NULL, /* Ignored */
        0, /* Ignored */
        0, /* Ignored */
        NULL, /* Ignored */
        3, /* Number of members */
        GlobalAlarmSettingsObjective_g_tc_members, /* Members */
        DDS_VM_NONE /* Ignored */
    }}; /* Type code for GlobalAlarmSettingsObjective*/

    if (is_initialized) {
        return &GlobalAlarmSettingsObjective_g_tc;
    }


    GlobalAlarmSettingsObjective_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::MetricIdentifier_get_typecode();
    GlobalAlarmSettingsObjective_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_float;
    GlobalAlarmSettingsObjective_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_float;
...
RTIBool GlobalAlarmSettingsObjective_initialize(
  ...
  return ::ice::GlobalAlarmSettingsObjective_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
}
        
RTIBool GlobalAlarmSettingsObjective_initialize_ex(
    GlobalAlarmSettingsObjective* sample,RTIBool allocatePointers,RTIBool allocateMemory)
{
...
void GlobalAlarmSettingsObjective_finalize(
    GlobalAlarmSettingsObjective* sample)
{
    ::ice::GlobalAlarmSettingsObjective_finalize_ex(sample,RTI_TRUE);
}
        
void GlobalAlarmSettingsObjective_finalize_ex(
    GlobalAlarmSettingsObjective* sample,RTIBool deletePointers)
{        
    if (sample) { } /* To avoid warnings */
    if (deletePointers) {} /* To avoid warnings */
 ...
 * Defines:  TSeq, T
 *
 * Configure and implement 'GlobalAlarmSettingsObjective' sequence class.
 */
#define T GlobalAlarmSettingsObjective
#define TSeq GlobalAlarmSettingsObjectiveSeq
#define T_initialize_ex ::ice::GlobalAlarmSettingsObjective_initialize_ex
#define T_finalize_ex   ::ice::GlobalAlarmSettingsObjective_finalize_ex
#define T_copy       ::ice::GlobalAlarmSettingsObjective_copy
...
/* ========================================================================= */
const char *LocalAlarmSettingsObjectiveTYPENAME = "ice::LocalAlarmSettingsObjective";

DDS_TypeCode* LocalAlarmSettingsObjective_get_typecode()
{
    static RTIBool is_initialized = RTI_FALSE;


    static DDS_TypeCode_Member LocalAlarmSettingsObjective_g_tc_members[4]=
    {
        {
            (char *)"unique_device_identifier",/* Member name */
            {
    ...
    static DDS_TypeCode LocalAlarmSettingsObjective_g_tc =
    {{
        DDS_TK_STRUCT,/* Kind */
        DDS_BOOLEAN_FALSE, /* Ignored */
        -1,/* Ignored */
        (char *)"ice::LocalAlarmSettingsObjective", /* Name */
        NULL, /* Ignored */
        0, /* Ignored */
        0, /* Ignored */
        NULL, /* Ignored */
        4, /* Number of members */
        LocalAlarmSettingsObjective_g_tc_members, /* Members */
        DDS_VM_NONE /* Ignored */
    }}; /* Type code for LocalAlarmSettingsObjective*/

    if (is_initialized) {
        return &LocalAlarmSettingsObjective_g_tc;
    }


    LocalAlarmSettingsObjective_g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)ice::UniqueDeviceIdentifier_get_typecode();
    LocalAlarmSettingsObjective_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)ice::MetricIdentifier_get_typecode();
    LocalAlarmSettingsObjective_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_float;
    LocalAlarmSettingsObjective_g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_float;
...
RTIBool LocalAlarmSettingsObjective_initialize(
  ...
  return ::ice::LocalAlarmSettingsObjective_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
}
        
RTIBool LocalAlarmSettingsObjective_initialize_ex(
    LocalAlarmSettingsObjective* sample,RTIBool allocatePointers,RTIBool allocateMemory)
{
...
void LocalAlarmSettingsObjective_finalize(
    LocalAlarmSettingsObjective* sample)
{
    ::ice::LocalAlarmSettingsObjective_finalize_ex(sample,RTI_TRUE);
}
        
void LocalAlarmSettingsObjective_finalize_ex(
    LocalAlarmSettingsObjective* sample,RTIBool deletePointers)
{        
    if (sample) { } /* To avoid warnings */
    if (deletePointers) {} /* To avoid warnings */
 ...
 * Defines:  TSeq, T
 *
 * Configure and implement 'LocalAlarmSettingsObjective' sequence class.
 */
#define T LocalAlarmSettingsObjective
#define TSeq LocalAlarmSettingsObjectiveSeq
#define T_initialize_ex ::ice::LocalAlarmSettingsObjective_initialize_ex
#define T_finalize_ex   ::ice::LocalAlarmSettingsObjective_finalize_ex
#define T_copy       ::ice::LocalAlarmSettingsObjective_copy
