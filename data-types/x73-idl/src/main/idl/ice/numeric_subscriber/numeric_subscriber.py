...
class ice_NumericSubscriber:
    ...
    def run_subscriber(domain_id: int, sample_count: int):
        ...
        topic = dds.Topic(participant, ice.NumericTopic, ice.Numeric)

        # This DataReader reads data on Topic "Example ice_Numeric".
        ...
        def condition_handler(_):
            ...
            nonlocal reader
            samples_read += ice_NumericSubscriber.process_data(reader)
        ...
        while samples_read < sample_count:
            ...
            try:
                ...
                # when they activate
                print("Numeric subscriber sleeping for 1 seconds...")
