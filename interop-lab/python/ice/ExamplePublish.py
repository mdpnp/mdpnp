# Publishing now included as the publish_to_dds() method of Numeric, SampleArray and DeviceIdentity classes
# This method of publishing is therefore now redundant - see ExampleInbuiltPublish for updated method
