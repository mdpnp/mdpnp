...
//							iu = (MutableIdentifiableUpdate<?>) mutableConstructor.newInstance();
	...
	public DDSBinding(String settings, Role role, Gateway gateway) throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
	    this(null==settings?0:Integer.parseInt(settings), role, gateway);
	}
