...
public class CSVPersisterTest {
    ...
    public void testCVSLineNumeric() throws Exception {
        ...
        Assert.assertEquals("Invalid csv line", "DEVICE0,METRIC0,0,20150203235809-0500,1,13.31", line);
    }
    ...
    public void testCVSLineArray() throws Exception {
        ...
        Assert.assertEquals("Invalid csv line", "DEVICE0,METRIC0,0,20150203235809-0500,5,1.000E0,1.100E0,1.200E0,1.300E0,1.400E0", line0);
        ...
        Assert.assertEquals("Invalid csv line", "DEVICE0,METRIC0,0,20150203235809-0500,4,1.000E-4,2.000E-4,3.000E-4,4.000E-4", line1);
