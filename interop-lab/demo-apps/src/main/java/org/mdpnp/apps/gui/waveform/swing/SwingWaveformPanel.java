...
import org.mdpnp.apps.gui.waveform.AbstractNestedWaveformSource;
import org.mdpnp.apps.gui.waveform.CachingWaveformSource;
import org.mdpnp.apps.gui.waveform.EvenTempoWaveformSource;
import org.mdpnp.apps.gui.waveform.NestedWaveformSource;
import org.mdpnp.apps.gui.waveform.TestWaveformSource;
import org.mdpnp.apps.gui.waveform.WaveformCanvas;
import org.mdpnp.apps.gui.waveform.WaveformPanel;
import org.mdpnp.apps.gui.waveform.WaveformRenderer;
...
public class SwingWaveformPanel extends javax.swing.JComponent implements WaveformCanvas, WaveformSourceListener, WaveformPanel {
	...
	private static class ExtentImpl extends org.mdpnp.apps.gui.waveform.ExtentImpl {
	...
	public void setRawSource(WaveformSource source) {
		...
		if(null != this.source) {
			...
			if(dct) {
				this.dct_source = new DCTSource(this.source);
