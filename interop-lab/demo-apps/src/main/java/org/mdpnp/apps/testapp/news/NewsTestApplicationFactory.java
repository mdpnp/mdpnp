...
public class NewsTestApplicationFactory implements IceApplicationProvider {
    private final IceApplicationProvider.AppType NewsTestApplication = new IceApplicationProvider.AppType("Early Warning", "NONEWS",
            NewsTestApplicationFactory.class.getResource("news.png"), 0.75, false);

    @Override
    public IceApplicationProvider.AppType getAppType() {
        return NewsTestApplication;
    ...
    public IceApplicationProvider.IceApp create(ApplicationContext parentContext) throws IOException {
        ...
        String fxml = System.getProperty("ChartApplication.fxml", "NewsTestApplication.fxml");
