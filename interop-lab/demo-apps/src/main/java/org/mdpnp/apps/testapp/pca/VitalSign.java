...
public enum VitalSign {
  HeartRate("Heart Rate", "bpm", new int[] { ice.MDC_PULS_OXIM_PULS_RATE.VALUE, ice.MDC_PULS_RATE.VALUE /*, ice.MDC_PULS_RATE_NON_INV.VALUE, ice.MDC_BLD_PULS_RATE_INV.VALUE, ice.MDC_PULS_RATE.VALUE*/ }, 40f, 140f, 20f, 160f, 0f, 250f, 5000L, 5000L),
