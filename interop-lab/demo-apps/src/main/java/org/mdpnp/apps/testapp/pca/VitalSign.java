...
public enum VitalSign {
  HeartRate("Heart Rate", "bpm", new int[] { ice.MDC_PULS_OXIM_PULS_RATE.VALUE/*, ice.MDC_PULS_RATE_NON_INV.VALUE, ice.MDC_BLD_PULS_RATE_INV.VALUE, ice.MDC_PULS_RATE.VALUE*/ }, 40f, 140f, 20f, 160f, 0f, 250f),
  SpO2("SpO\u2082", "%", new int[] { ice.MDC_PULS_OXIM_SAT_O2.VALUE }, 95f, null, 80f, null, 60f, 100f),
  RespiratoryRate("Respiratory Rate", "bpm", new int[] { ice.MDC_RESP_RATE.VALUE }, 8f, 16f, 2f, 35f, 0f, 40f),
  EndTidalCO2("etCO\u2082", "mmHg", new int[] { ice.MDC_AWAY_CO2_EXP.VALUE }, 20f, 50f, 10f, 45f, 0f, 100f),
