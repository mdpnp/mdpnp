...
public class DiagnosticApplication {
	...
	@FXML
	protected TableView<NumericFx> numericTable;
	@FXML
	protected TableView<SampleArrayFx> sampleArrayTable;
	@FXML
	protected TableView<AlertFx> patientAlertTable, technicalAlertTable;
	@FXML
	protected TableView<Validation> validationTable;
	@FXML
	protected TableView<InfusionStatusFx> infusionStatusTable;
	@FXML
	protected TableView<BypassStatusFx> bypassStatusTable;
	@FXML
	protected TableView<AlarmLimitFx> alarmLimitTable;
	@FXML
	protected TableView<LocalAlarmLimitObjectiveFx> localAlarmLimitObjectiveTable;
	@FXML
	protected TableView<GlobalAlarmLimitObjectiveFx> globalAlarmLimitObjectiveTable;
	...
	public void setModel(Diagnostic diagnostic) {
		...
		bypassStatusTable.setItems(diagnostic.getBypassStatusList());
